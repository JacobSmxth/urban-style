        ...
        <Grid container spacing={6} alignItems="center">
          <Grid item xs={12} md={6}>
            <Box sx={{
              ...
              >
                The Urban Style Journey
              </Typography>
              <Typography paragraph sx={{ mb: 3 }}>
                Urban Style began with a simple yet powerful idea: to create a fashion destination that celebrates individuality and style. Our journey started in 2024, and since then, we have been dedicated to bringing you the finest selection of fashion and accessories.
              </Typography>
              <Typography paragraph sx={{ mb: 3 }}>
